...
// Function to get local bank logo path - use bin code instead of bank code
export const getBankLogoPath = (bin: string): string => {
  return `/images/banks/${bin.toLowerCase()}.png`;
};
