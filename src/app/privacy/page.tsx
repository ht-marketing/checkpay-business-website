...
export const metadata: Metadata = {
  title: "Điều khoản sử dụng | Check Pay",
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <ul>
                  <li>
                    <p>
                      ...
                      Company downloaded by You on any electronic device, named Check Pay
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      ...
                      "Us" or "Our" in this Agreement) refers to Check Pay, Ho Chi Minh City.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Check Pay Web, accessible from{" "}
                      <a
                        href="https://checkpay.vn"
                ...
                <h2 className="text-3xl mt-4">Acknowledgment</h2>
                <p>
                ...
                <h2 className="text-3xl mt-4">Termination</h2>
                <p>
                ...
                <h2 className="text-3xl mt-4">Limitation of Liability</h2>
                <p>
                ...
                <h2 className="text-3xl mt-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
                <p>
                ...
                <h2 className="text-3xl mt-4">Governing Law</h2>
                <p>
                ...
                <h2 className="text-3xl mt-4">Disputes Resolution</h2>
                <p>
                ...
                <h2 className="text-3xl mt-4">For European Union (EU) Users</h2>
                <p>
                  If You are a European Union consumer, you will benefit from any mandatory
                  provisions of the law of the country in which You are resident.
                </p>
                <h2 className="text-3xl mt-4">United States Legal Compliance</h2>
                <p>
                ...
                <h2 className="text-3xl mt-4">Severability and Waiver</h2>
                <h3>Severability</h3>
                <p>
                ...
                <h2 className="text-3xl mt-4">Translation Interpretation</h2>
                <p>
                  These Terms and Conditions may have been translated if We have made them
                  available to You on our Service. You agree that the original English text
                  shall prevail in the case of a dispute.
                </p>
                <h2 className="text-3xl mt-4">Changes to These Terms and Conditions</h2>
                <p>
